...
#ifndef __R_FPLS_R_H__
#define __R_FPLS_R_H__
...
class R_FPLS_R_SpaceOnly : public R_FPLS_R<SpaceOnly> {
  public:
    R_FPLS_R_SpaceOnly(Rcpp::Environment pde,
                      int sampling_type,
